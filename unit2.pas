...
begin
  ...
  begin
    ...
    begin
      ...
      //KEYBD_EVENT(VK_SCROLL,0,0,0);     //first, simple way to keep pc from entering screen saver & hibernate, enabling capslock
      //KEYBD_EVENT(VK_SCROLL,0,KEYEVENTF_KEYUP,0); //disabling capslock
